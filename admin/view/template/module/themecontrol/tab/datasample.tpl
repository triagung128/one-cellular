	...
	<div class="panel panel-info">
		...
		<div class=" panel-body">
			<p class="alert alert-success">
				   <span><a rel="install" class="btn   btn-danger" href="<?php echo $ourl->link('module/themecontrol/storesample', 'theme='.$module['default_theme'].'&token=' . $token, 'SSL');?>">
	...
	<div class="panel ">
		...
		<div class="panel-body">
			<table class="form">
				...
				<tr>
					<td>
						<a href="<?php echo $ourl->link('module/'.$umodule['code'], 'token=' . $token, 'SSL');?>"><?php echo $umodule['title']; ?></a>
					</td>
					<td>
