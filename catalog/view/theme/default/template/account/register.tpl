  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account" style="margin-bottom: 20px;">
          <legend style="padding-bottom: 0px"><?php echo $text_your_details; ?></legend>
        ...
        <fieldset id="address" style="margin-bottom: 20px;">
          <legend style="padding-bottom: 0px"><?php echo $text_your_address; ?></legend>
          <div class="form-group">
        ...
        <fieldset style="margin-bottom: 20px;">
          <legend style="padding-bottom: 0px"><?php echo $text_your_password; ?></legend>
          <div class="form-group required">
        ...
        <fieldset style="margin-bottom: 20px;">
          <legend style="padding-bottom: 0px"><?php echo $text_newsletter; ?></legend>
          <div class="form-group">
