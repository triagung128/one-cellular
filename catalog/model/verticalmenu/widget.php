...
class ModelVerticalmenuWidget extends Model {		
	...
	protected function getLayout( $layout ){
		if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/template/module/pavverticalmenu/widgets/'.$layout.'.tpl')) {
			$template = DIR_TEMPLATE.$this->config->get('theme_default_directory') . '/template/module/pavverticalmenu/widgets/'.$layout.'.tpl';
		} else {
